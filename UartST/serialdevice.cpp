...
const QString SerialDevice::currentBaudRate(){
...
const QString SerialDevice::currentParity(){
...
const QString SerialDevice::currentDataBits(){
...
const QString SerialDevice::currentStopBits(){
...
const QString SerialDevice::currentWriteInterval(){
    return QString::number(m_writeInterval);
}

void SerialDevice::setWriteInterval(int value){
    m_writeInterval = value;
}
