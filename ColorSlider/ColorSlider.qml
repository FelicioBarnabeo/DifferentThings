...
Item {
    ...
    property string currentHue: "black"
    ...
    Rectangle{
        ...
        MouseArea{
            ...
            onReleased: {
                ...
                if(root.currentProcentLight==100) root.currentProcentLight=root.currentProcentLight-1;
                switcher.color = colordefiner.getColorValue(root.currentHue,root.currentProcentLight - root.currentProcentLight%10);
    ...
    Rectangle{
        ...
        MouseArea{
            ...
            onPressed: {
                ...
                {
                    root.offClicked();
                    switcher.unPress = "white";
                    root.currentHue = "white";

                }
                else
                {
                    //switcher.color = "white";
                    switcher.unPress = "black";
                    root.currentHue = "black";
                    root.onClicked();
                }
            }
